    ...
    <div class="bg-white rounded-lg shadow-xl overflow-hidden max-w-2xl w-full flex flex-col max-h-[90vh]">
      ...
      <div class="px-4 py-3 border-t border-gray-200 bg-gray-50 flex justify-between items-center">
        <div class="flex gap-2">
          <button type="button" @click="rotate(-90)" class="p-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100" title="Rotate Left">
            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" />
            </svg>
          </button>
          <button type="button" @click="rotate(90)" class="p-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100" title="Rotate Right">
            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 10h-10a8 8 0 00-8 8v2M21 10l-6 6m6-6l-6-6" />
            </svg>
          </button>
          <button type="button" @click="reset" class="p-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-100" title="Reset">
            <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
