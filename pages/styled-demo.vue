<template>
  <div class="max-w-4xl mx-auto space-y-8">
    <div class="border-b border-gray-200 pb-5">
      <h1 class="text-3xl font-bold leading-tight text-gray-900">Styled Components Demo</h1>
      <p class="mt-2 text-lg text-gray-500">
        CSS-in-JS styling for Vue 3 using vue3-styled-components.
      </p>
    </div>
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
      ...
      <div class="p-8 flex flex-col items-center justify-center bg-gray-50/50 gap-6">
        ...
        <p class="text-sm text-gray-500">
          Try hovering over the buttons to see the transition effects defined in the styled component.
        </p>
      </div>
    </div>
...
export default StyledButton</code></pre>
    ...
    <div class="border-b border-gray-200 pb-5 pt-8">
      <h2 class="text-2xl font-bold leading-tight text-gray-900">Styled Components with TSX</h2>
      <p class="mt-2 text-lg text-gray-500">
        Using styled-components within TSX files for powerful component composition.
      </p>
    </div>
    ...
    <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
      <div class="border-b border-gray-100 bg-gray-50 px-6 py-4">
        <h2 class="text-lg font-medium text-gray-900">TSX Component Demo</h2>
      </div>
      <div class="p-8 flex flex-col items-center justify-center bg-gray-50/50 gap-6">
        <div class="flex flex-wrap gap-4 justify-center">
          <StyledTsxButton label="Primary" variant="primary" />
          <StyledTsxButton label="Success" variant="success" />
          <StyledTsxButton label="Warning" variant="warning" />
          <StyledTsxButton label="Danger" variant="danger" />
        </div>
      </div>
    </div>
